...
bool isPossibleToMoveSofa(vector<vector<char>> &houseThingsArrangementMatrix, int rows, int cols, vector<vector<string>> &movesPathToMoveSofa, vector<string> &moves, SofaPosition &sofaPosition, SofaPosition &sofaEndPosition)
{
...
int findTotalMovesToMoveSofaToDestination(vector<vector<char>> houseThingsArrangementMatrix, int rows, int cols)
{
    ...
    vector<string> moves;
    bool moved = isPossibleToMoveSofa(houseThingsArrangementMatrix, rows, cols, movesPathToMoveSofa, moves, sofaStartPosition, sofaEndPosition);
    ...
    {
        // cout << "Bhai moved == " << moved << " and  movesPathToMoveSofa.size() == " << movesPathToMoveSofa.size() << endl << endl;
        int minimumMoves = 0;
